            ...
            <div className='grid grid-cols-1 place-items-center'>
                <motion.div
                    ...
                    <div className='grid grid-cols-2'>
                        ...
                        <Link to="https://github.com/Alicexplore/The_Sneakers_Project" target="blank" ><button className='my-4 font-inter dark:text-[#222222] dark:bg-[#f2f2f2] text-[#f2f2f2] px-12 py-12 text-lg rounded-sm 
                            border border-[#2e2e2d] dark:border-[#f2f2f2] dark:hover:text-[#3b3b3b] bg-[#2e2e2d] hover:text-[#d4d4d4] 
                            hover:bg-[#222222] duration-500 cursor-pointer flex items-center justify-center'><span className=''><ion-icon name="logo-github"></ion-icon></span></button></Link> 
                        </div>
                    </div>
