...
const About = () => {
    ...
    return (
        <section className='section px-7 py-4 font-inter bg-[#010101] dark:bg-[#222222] text-[#2e2e2d] dark:text-[#010101] h-auto' id='about' ref={ref}>
            <div className='container mx-auto'>
                <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0'>
                    ...
                    className='flex-1 bg-about bg-contain bg-no-repeat bg-top'>
                        <img className='' src="./nfts/illu-3-03.png" alt="Alice's Desk" width={600}/>
                    ...
                    <div className='flex-1'>
                        ...
                        viewport={{ once: false, amount: 0}}>
                            ...
                            <div className='flex items-center place-content-center justify-center'>
                                <Link to='contact' activeClass='active' smooth={true} spy={true} ><button className=' my-4 font-inter dark:text-[#222222] dark:bg-[#010101] text-[#010101] px-4 py-2 text lg:text-md rounded-sm 
                                border border-[#2e2e2d] dark:border-[#010101] dark:hover:text-[#3b3b3b] bg-[#2e2e2d] hover:text-[#d4d4d4] 
                              hover:bg-[#222222] duration-500 cursor-pointer'>Contact Me</button></Link>
                                <a href="https://drive.google.com/file/d/1CEtNgne0fBz7KuN5DUPeKhHWSy8qILeQ/view?usp=share_link" target="blank" ><button className='mx-7 lg:mx-8 my-4 font-inter dark:text-[#222222] dark:bg-[#010101] text-[#010101] px-4 py-2 text-md rounded-sm 
                                border border-[#2e2e2d] dark:border-[#010101] dark:hover:text-[#3b3b3b] bg-[#2e2e2d] hover:text-[#d4d4d4] 
