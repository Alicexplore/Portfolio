...
const About = () => {
    ...
    return (
        <section className='section px-7 py-4 font-inter bg-[#f2f2f2] dark:bg-[#222222] text-[#222222] dark:text-[#f2f2f2] h-[100vh]' id='about' ref={ref}>
            <div className='container mx-auto'>
                <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0'>
                    ...
                    className='flex-1 bg-about bg-contain bg-no-repeat bg-top'>
                        <img className='' src="" alt="Alice's Desk" width={600}/>
                    ...
                    <div className='flex-1'>
                        ...
                        whileInView={'show'}
                        viewport={{ once: false, amount: 0}}>
                            <h1 className='text-[4rem] md:text-[7.6rem] -ml-1 md:-ml-2 font-medium leading-tight'>ALICE<br />BERGONHE</h1>
                            ...
                            <div className='flex items-center place-content-center justify-center'>
                                <Link to='contact' activeClass='active' smooth={true} spy={true} ><button className='my-4 font-inter text-[#f2f2f2]
                                 dark:text-[#222222] dark:bg-[#f2f2f2] text-[#222222] px-4 py-2 text lg:text-md rounded-sm 
