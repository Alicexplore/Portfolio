...
const About = () => {
    ...
    return (
        <section className='section px-7 py-4 font-inter bg-[#f2f2f2] dark:bg-[#222222] text-[#222222] dark:text-[#f2f2f2] h-auto' id='about' ref={ref}>
            <div className='container mx-auto'>
                <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0'>
                    ...
                    className='flex-1 bg-about bg-contain bg-no-repeat bg-top'>
                        <img className='' src="./nfts/bwhite.png" alt="Alice's Desk" width={600}/>
